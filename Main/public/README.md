...
|----------|-------------|----------------|
| Hardware | Computadora o netbook | Sin costo (ya disponible) |
| Software | Visual Studio Code | Sin costo |
| Software | Navegador web (Chrome, Edge o Firefox) | Sin costo |
| Software | Git y GitHub | Sin costo |
| Software | Node.js y npm | Sin costo |
| Software | React | Sin costo |
| Conectividad | Conexión a Internet | $750 por mes |
